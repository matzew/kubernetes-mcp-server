...
keycloak-acm-register-managed-cluster: ## Register managed cluster and configure OIDC (requires: CLUSTER_NAME, MANAGED_KUBECONFIG)
	...
	@echo ""
	@echo "This will:"
	@echo "  1. Create managed cluster realm in Keycloak"
	@echo "  2. Configure cross-realm token exchange"
	@echo "  3. Enable TechPreviewNoUpgrade on managed cluster"
	@echo "  4. Configure OIDC authentication"
	@echo "  5. Create RBAC for service-account-mcp-server"
	@echo ""
